...
export enum TaxTypeEnumeratedType {
    ...
    /**Tax charged on service contracts (where applicable) */
    ServiceContract = 'Service Contract',
    /**Adjusted sales tax due to tax modifications when capitalized (i.e. NY) */
    AdjustedSales = 'Adjusted Sales',
    /**The total amount of sales/use tax for a single payment contract */
    TotalSalesUse = 'Total Sales/Use',
    /**Provincal tax providing for the installation or removal of freon (Canada) */
    AirConditioningExcise = 'Air Conditioning Excise',
    ...
    /**A county tax charged basd on the location of the dealer and the customer */
    ...
    MuncipalHazardAndSpecialWaste = 'Muncipal Hazard and Special Waste',
    /**Environmental Levy / Tax */
    EnvironmentalTax = 'Environmental Tax',
    /**Tax paid at of registration based on the vehicle's age and MSRP. */
    ...
    WheelTax = 'Wheel Tax',
    GOGTax = 'GOG Tax',
    MiscellaneousMaterialsTax = 'Misc Materials Tax',
...
export enum PriceEnumeratedType {
    ...
    Sold = 'Sold',
    /**The vehicle invoice amount minus the dealer's holdback amount which is the amount that is paid to the dealer 
     * on a vehicle basis refunding the dealer for inflated vehicle invoice amounts. */
    ActualWholesalePrice = 'Actual Wholesale Price',
    /**Discount off the original retail price by the Dealer */
    DealerDiscountAmount = 'Dealer Discount Amount',
    /**Discount off the original retail price by the OEM (comes out of the OEM's revenue) */
    ...
    /**The submitted price is the dealer's while the Retail price is the OEM's.  THe OEM will classify the dealer's submnitted retail price as the submitted price */
    ...
    OtherSurchaseAmount = 'OtherSurchargeAmount',
    ...
    TotalWarrantySubletCost = 'Total Wararnty Sublet Cost',
    ...
    /**Dealer offer price for known customers */
    VehicleSellingPrice = 'Vehicle Selling Price',
    /**Dealer Invoice cost of dealer installed options */
...
/**Language conforms to ISO 639-2 rules.  Note the format for this field is language-Country */
export enum LanguageEnumeratedType {
    ...
    BashkirRussianFederation = 'ba-RU',
    ...
    LaothianLaoPeoplesDemocraticRepublic = 'lo-LA',
...
/**Country in which the Address is in.  Conforms to ISO 3166-2 Alpha-2 */
export enum TwoLetterCountryEnumType {
    UnitedStates = 'US',
    Afghanistan = 'AF',
    Albania = 'AL',
    Algeria = 'DZ',
...
/**Country in which the Address is in.  Conform to ISO 3166-2 Alpha-3 codes */
export enum ThreeLetterCountryEnumType {
    UnitedStates = 'USA',
    Afghanistan = 'AFG',
    Albania = 'ALB',
    Algeria = 'DZA',
...
/**Idnetifies marital status of business party */
...
export enum DriveTypeEnumeratedType {
    ...
    /**Rear wheel drive */
    Rear = 'Rear',
    /**The engine is located inboard just forward transom (sterm) and delivers power via a shaft that goes through the transom to the drive unit. */
    Stern = 'Stern',
...
export enum TransmissionTypeEnumeratedType {
    ...
    SixSpeed = '6',
    Automatic = 'A',
    AutomaticThree = 'Automatic 3',
    AutomaticFour = 'Automatic 4',
    AutomaticFive = 'Automatic 5',
    AutomaticSix = 'Automatic 6',
    AutomaticSeven = 'Automatic 7',
    SevenSpeed = '7',
